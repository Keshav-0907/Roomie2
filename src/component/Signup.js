    ...
    <div className='main-container'>     
      ...
      <div  className='input'>
        ...
        <div>
          ...
          <div>
            <input  className='inp' type="email" placeholder='Enter Your E-Mail' />
          </div> 

          <div>
            <input className='inp' type="number" placeholder='Enter Phone Number +91 XXXX XXX XXX'/>
          </div> 
          ...
          <Link to='/' > <button className='bt-1'> Submit </button>  </Link> 
          <div className='if-reg'>
             Already Registered ??  <Link to='/Log' > Log In </Link>
          </div>
      </div>
